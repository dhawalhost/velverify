...
- `cmd/admincli` provides a lightweight CLI: `go run ./cmd/admincli list -tenant admin-system` or `create` with flags for redirects/scopes/secret. Use this until the Admin UI wires the same APIs.
