        ...
        >
            ...
            <div className="flex-1 relative group">
                ...
                <Input
                    ...
                    className="pl-9 h-9 border-none rounded-lg bg-card ring-1 ring-on-surface/5 focus-visible:ring-2 focus-visible:ring-primary/20 transition-all font-medium text-sm"
                    value={value}
            ...
            {showFilterButton && (
                <Button
                    type="submit"
                    className="h-9 rounded-lg px-4 font-bold text-[11px] tracking-tight shadow-sm shadow-primary/10 transition-all shrink-0"
                >
