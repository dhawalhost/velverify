    ...
    return (
        <div className="min-h-screen bg-surface flex flex-col font-sans selection:bg-primary/10 selection:text-primary">
                    ...
                    <div className="flex items-center gap-4">
                        <Link to="/portal" className="flex items-center gap-2 group">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-[9px] font-bold tracking-tight text-on-surface-variant/40 leading-none mt-0.5 uppercase">User portal</span>
                            </div>
                        </Link>
                    </div>
            ...
            <main className="flex-1 container mx-auto px-6 py-8 relative">
                ...
                <div className="flex items-center justify-between mb-6 border-b border-on-surface/5 pb-4">
                    <div className="flex items-center gap-4">
            ...
            <footer className="border-t border-on-surface/5 py-6 bg-card/50">
