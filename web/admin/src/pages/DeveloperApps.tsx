    ...
    return (
        <div className="space-y-10 animate-in fade-in duration-700">
            ...
            {(createdSecret || createdAPIKey) && (
                <div className="bg-success-subtle ring-1 ring-emerald-500/20 p-10 rounded-[32px] relative overflow-hidden group animate-in slide-in-from-top-4">
            ...
            <Tabs defaultValue="apps" className="w-full" onValueChange={setActiveTab}>
                <TabsList className="h-auto p-1.5 bg-surface-container/50 rounded-[24px] ring-1 ring-on-surface/5 flex flex-wrap gap-1 mb-10">
                    <TabsTrigger
                        value="apps"
                        className="h-12 px-8 rounded-xl data-[state=active]:bg-card data-[state=active]:text-primary data-[state=active]:shadow-sm font-bold text-[11px] tracking-tight transition-all text-on-surface-variant/40 hover:text-on-surface"
                    >
                        <Smartphone className="mr-2 h-3.5 w-3.5" /> Applications
                    </TabsTrigger>
                    <TabsTrigger
                        value="keys"
                        className="h-12 px-8 rounded-xl data-[state=active]:bg-card data-[state=active]:text-primary data-[state=active]:shadow-sm font-bold text-[11px] tracking-tight transition-all text-on-surface-variant/40 hover:text-on-surface"
                    ...
                    <TabsTrigger
                        ...
                        className="h-12 px-8 rounded-xl data-[state=active]:bg-card data-[state=active]:text-primary data-[state=active]:shadow-sm font-bold text-[11px] tracking-tight transition-all text-on-surface-variant/40 hover:text-on-surface"
                    >
                        <Shield className="mr-2 h-3.5 w-3.5" /> SAML Settings
                    </TabsTrigger>
                    <TabsTrigger
                        value="scim"
                        className="h-12 px-8 rounded-xl data-[state=active]:bg-card data-[state=active]:text-primary data-[state=active]:shadow-sm font-bold text-[11px] tracking-tight transition-all text-on-surface-variant/40 hover:text-on-surface"
                    >
                        <RefreshCw className="mr-2 h-3.5 w-3.5" /> SCIM Sync
                    </TabsTrigger>
                </TabsList>

                {/* OAuth Apps Content */}
                <TabsContent value="apps" className="space-y-10 animate-in fade-in duration-500">
                    <div className="flex justify-between items-center bg-card rounded-[24px] p-8 shadow-xl shadow-on-surface/5 ring-1 ring-on-surface/5">
                        <div className="flex items-center gap-5">
                            <div className="p-3.5 bg-primary/10 rounded-2xl">
                                <Zap className="w-6 h-6 text-primary" />
                            </div>
                        <div className="flex flex-col">
                                <span className="text-on-surface font-bold text-lg tracking-tight leading-none">Register Application</span>
                                <span className="text-on-surface-variant/40 font-semibold text-[12px] mt-1 tracking-tight">Create a new OAuth2 client to integrate with WardSeal.</span>
                            </div>
                        </div>
                        <Button
                            onClick={() => setCreateAppOpen(!createAppOpen)}
                            className="bg-primary text-primary-foreground rounded-xl font-bold text-sm px-8 h-12 shadow-lg shadow-primary/10"
                        >
                            {createAppOpen ? 'Cancel' : <><Plus className="mr-2 h-4.5 w-4.5" /> Add App</>}
                        </Button>
                    </div>

                    {createAppOpen && (
                        <GlassCard className="border-none shadow-2xl shadow-on-surface/5 overflow-hidden rounded-[32px] scale-in-center bg-card">
                            <GlassCardHeader className="bg-surface-container p-12">
                                <GlassCardTitle className="text-4xl font-bold tracking-tight text-on-surface">New Application</GlassCardTitle>
                                <p className="text-on-surface-variant/60 font-medium text-sm mt-3">Provide details to register your application.</p>
                            </GlassCardHeader>
                            <GlassCardContent className="p-12 space-y-12">
                                <form onSubmit={handleCreateApp} className="space-y-10">
                                    <div className="grid gap-10 md:grid-cols-2">
                                        <div className="space-y-2.5">
                                            <Label className="text-[12px] font-bold tracking-tight text-on-surface-variant/40 ml-1">Application Name</Label>
                                            <Input
                                        ...
                                        <div className="space-y-2.5">
                                            <Label className="text-[12px] font-bold tracking-tight text-on-surface-variant/40 ml-1">Application Type</Label>
                                            <select
                                    ...
                                    <div className="grid gap-10 md:grid-cols-2">
                                        <div className="space-y-4">
                                            <Label className="text-[12px] font-bold tracking-tight text-on-surface-variant/40 ml-1">Permissions (Scopes)</Label>
                                        ...
                                        <div className="space-y-4">
                                            <Label className="text-[12px] font-bold tracking-tight text-on-surface-variant/40 ml-1">Login Flows</Label>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {apps.map(app => (
                            <GlassCard key={app.id} className="group border-none shadow-xl shadow-on-surface/5 hover:shadow-2xl hover:shadow-primary/5 transition-all overflow-hidden rounded-[32px] bg-card ring-1 ring-on-surface/5">
                                <GlassCardHeader className="bg-surface-container p-10 relative overflow-hidden">
                                    ...
                                    <div className="relative z-10 flex justify-between items-start">
                                        <div className="space-y-5">
                                            ...
                                            <p className="text-sm font-medium text-on-surface-variant/40 line-clamp-1">{app.description || "Default application configuration."}</p>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <Button size="icon" variant="ghost" className="h-10 w-10 text-on-surface-variant/40 hover:bg-card hover:text-primary rounded-xl" onClick={() => handleOpenEditApp(app)}>
                                                <Pencil className="h-4.5 w-4.5" />
                                            </Button>
                                            <Button size="icon" variant="ghost" className="h-10 w-10 text-on-surface-variant/40 hover:bg-destructive/10 hover:text-destructive rounded-xl" onClick={() => handleDeleteApp(app.id)}>
                                                <Trash2 className="h-4.5 w-4.5" />
                                            </Button>
                                        </div>
                                    </div>
                                </GlassCardHeader>
                                <GlassCardContent className="p-10 space-y-10 bg-card">
                                    <div className="grid grid-cols-2 gap-8 pb-8 border-b border-on-surface/5">
                                        <div>
                                            <span className="text-[11px] font-bold tracking-tight text-on-surface-variant/40">Permissions</span>
                                    ...
                                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                                        <Button variant="ghost" className="h-14 rounded-2xl bg-surface-container/30 hover:bg-primary hover:text-primary-foreground transition-all p-0 flex flex-col justify-center gap-1 group/btn" onClick={() => handleRotateSecret(app.id)}>
                                            <RefreshCw className="h-4 w-4 text-on-surface-variant/40 group-hover/btn:text-white transition-colors" />
                                            <span className="text-[10px] font-bold tracking-tight">Rotate Secret</span>
                                        </Button>
                                        <Button variant="ghost" className="h-14 rounded-2xl bg-surface-container/30 hover:bg-primary hover:text-primary-foreground transition-all p-0 flex flex-col justify-center gap-1 group/btn" onClick={() => handleManageAssignments(app)}>
                                            <Users className="h-4 w-4 text-on-surface-variant/40 group-hover/btn:text-white transition-colors" />
                                            <span className="text-[10px] font-bold tracking-tight">Permissions</span>
                                        </Button>
                                        <Button variant="ghost" className="h-14 rounded-2xl bg-surface-container/30 hover:bg-primary hover:text-primary-foreground transition-all p-0 flex flex-col justify-center gap-1 group/btn" onClick={() => setQuickstartApp(app)}>
                                            <Terminal className="h-4 w-4 text-on-surface-variant/40 group-hover/btn:text-white transition-colors" />
                                            <span className="text-[10px] font-bold tracking-tight">Quickstart</span>
                                        </Button>
                                        <Button variant="ghost" className="h-14 rounded-2xl bg-surface-container/30 hover:bg-success hover:text-white transition-all p-0 flex flex-col justify-center gap-1 group/btn" onClick={() => handleViewLogs(app.id, app.name, 'app')}>
                                            <Activity className="h-4 w-4 text-on-surface-variant/40 group-hover/btn:text-white transition-colors" />
                                            <span className="text-[10px] font-bold tracking-tight">Audit Logs</span>
                                        </Button>
                                    </div>
                                </GlassCardContent>
                            </GlassCard>
                ...
                <TabsContent value="keys" className="space-y-10 animate-in fade-in duration-500">
                    <div className="flex justify-end">
                        <Button
                            ...
                            className="bg-primary text-primary-foreground rounded-xl font-bold text-sm px-10 h-14 shadow-lg shadow-primary/10 transition-all"
                        >
                    ...
                    {createKeyOpen && (
                        <GlassCard className="max-w-2xl mx-auto border-none shadow-2xl rounded-[32px] bg-card overflow-hidden">
                            <GlassCardHeader className="bg-surface-container p-12">
                                <GlassCardTitle className="text-3xl font-bold tracking-tight text-on-surface">Create API Key</GlassCardTitle>
                                <GlassCardDescription className="text-sm font-medium text-on-surface-variant/40 mt-2">Create an API key for programmatic access to the WardSeal API.</GlassCardDescription>
                            </GlassCardHeader>
                        ...
                        <GlassCardHeader className="bg-surface-container/30 border-b border-on-surface/5 p-10">
                            <div className="flex items-center gap-6">
                                ...
                                <div className="space-y-1">
                                    <GlassCardTitle className="text-3xl font-bold tracking-tight text-on-surface">All API Keys</GlassCardTitle>
                                    <p className="text-[11px] font-bold uppercase tracking-widest text-on-surface-variant/40">{apiKeys.length} Active keys</p>
                                </div>
                            </div>
                        </GlassCardHeader>
                                    ...
                                    {apiKeys.map(key => (
                                        <div key={key.id} className="flex items-center justify-between p-10 hover:bg-surface-container/20 transition-all group">
                                            ...
                                            <div className="flex gap-3">
                                                <Button variant="ghost" className="h-12 rounded-xl bg-surface-container/50 font-bold text-[11px] tracking-tight hover:bg-primary hover:text-primary-foreground px-8 transition-all" onClick={() => handleViewLogs(key.id, key.name, 'key')}>
                                                    <Activity className="mr-2 h-4 w-4 opacity-40" /> Logs
                                                </Button>
                                                <Button variant="ghost" className="h-12 rounded-xl bg-surface-container/50 font-bold text-[11px] tracking-tight hover:bg-destructive/100 hover:text-white px-8 text-destructive transition-all" onClick={() => handleRevokeKey(key.id)}>
                                                    Revoke
                                                </Button>
                                            </div>
                                        </div>
                ...
                <TabsContent value="idp" className="space-y-10 animate-in fade-in duration-500">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                        <GlassCard className="border-none shadow-xl shadow-on-surface/5 bg-card rounded-[32px] overflow-hidden ring-1 ring-on-surface/5">
                            <GlassCardHeader className="bg-surface-container p-10 relative overflow-hidden">
                                ...
                                <div className="relative z-10 space-y-4">
                                    <div className="flex items-center gap-4">
                                        <Badge className="bg-primary/10 text-primary rounded-xl h-7 font-bold text-[10px] tracking-tight px-3 border-none">Protocol</Badge>
                                        <span className="text-[11px] font-bold tracking-tight text-on-surface-variant/40">OpenID Connect</span>
                                    </div>
                                    <GlassCardTitle className="text-4xl font-bold tracking-tight text-on-surface">OIDC Configuration</GlassCardTitle>
                                    <p className="text-sm font-medium text-on-surface-variant/40">Public endpoints for your OIDC integration.</p>
                                </div>
                            </GlassCardHeader>
                                ...
                                <div className="space-y-6 flex-1">
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex gap-3">
                                            ...
                                            <Button variant="ghost" className="h-12 w-12 rounded-xl bg-surface-container/30 ring-1 ring-on-surface/5 p-0 hover:bg-primary hover:text-primary-foreground transition-all shadow-sm" onClick={() => handleCopyValue('Issuer URL', currentIssuerBaseURL)}>
                                    ...
                                    <div className="p-8 bg-primary/5 rounded-[24px] ring-1 ring-primary/10 space-y-4">
                                        ...
                                        <div className="font-mono text-[10px] text-on-surface-variant/40 truncate bg-card/50 p-3 rounded-lg ring-1 ring-on-surface/5">
                            ...
                            <GlassCardHeader className="bg-surface-container p-10 relative overflow-hidden">
                                ...
                                <div className="relative z-10 space-y-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <span className="text-[11px] font-bold tracking-tight text-on-surface-variant/40">SAML 2.0</span>
                                    </div>
                                    <GlassCardTitle className="text-4xl font-bold tracking-tight text-on-surface">SAML Configuration</GlassCardTitle>
                                    <p className="text-sm font-medium text-on-surface-variant/40">Public endpoints for your SAML integration.</p>
                                </div>
                            </GlassCardHeader>
                            <GlassCardContent className="p-10 space-y-10">
                                <div className="space-y-6">
                                    <div className="space-y-3">
                                        <Label className="text-[12px] font-bold tracking-tight text-on-surface-variant/40 ml-1">Metadata URL</Label>
                                        <div className="flex gap-3">
                                            ...
                                            <Button variant="ghost" className="h-12 w-12 rounded-xl bg-surface-container/30 ring-1 ring-on-surface/5 p-0 hover:bg-primary hover:text-primary-foreground transition-all shadow-sm" onClick={() => handleCopyValue('Metadata URL', `${window.location.origin}/saml/metadata`)}>
                                                <Copy className="h-5 w-5" />
                                            </Button>
                                        </div>
                                    </div>
                                    <div className="space-y-3">
                                        <Label className="text-[12px] font-bold tracking-tight text-on-surface-variant/40 ml-1">ACS URL</Label>
                                        <div className="flex gap-3">
                                            ...
                                            <Button variant="ghost" className="h-12 w-12 rounded-xl bg-surface-container/30 ring-1 ring-on-surface/5 p-0 hover:bg-primary hover:text-primary-foreground transition-all shadow-sm" onClick={() => handleCopyValue('SSO URL', `${window.location.origin}/saml/sso`)}>
                                                <Copy className="h-5 w-5" />
                                            </Button>
                                        </div>
                                    </div>
                        ...
                        <GlassCardHeader className="bg-surface-container p-10 flex flex-row items-center justify-between">
                            <div className="flex items-center gap-6">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-[11px] font-bold uppercase tracking-widest text-on-surface-variant/40">SAML Service Providers</p>
                                </div>
                            </div>
                            <Button
                                onClick={() => setCreateSAMLOpen(!createSAMLOpen)}
                                className="bg-card text-primary rounded-xl font-bold text-sm px-8 h-12 shadow-sm ring-1 ring-on-surface/5 hover:ring-on-surface/10"
                            >
                                {createSAMLOpen ? 'Cancel' : <><Plus className="mr-2 h-4.5 w-4.5" /> Add Provider</>}
                            </Button>
                        </GlassCardHeader>
                        <GlassCardContent className="p-0">
                            {createSAMLOpen && (
                                <div className="p-10 border-b border-on-surface/5 bg-surface-container/10 animate-in slide-in-from-top-4 duration-500">
                                    <form onSubmit={handleCreateSAMLProvider} className="space-y-10">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                            <div className="space-y-2.5">
                                                <Label className="text-[12px] font-bold tracking-tight text-on-surface-variant/40 ml-1">Entity ID</Label>
                                                <Input
                                                    ...
                                                    required
                                                    className="h-12 border-none rounded-xl bg-card ring-1 ring-on-surface/5 focus-visible:ring-2 focus-visible:ring-primary/20 font-mono text-sm p-6"
                                                />
                                            </div>
                                            <div className="space-y-2.5">
                                                <Label className="text-[12px] font-bold tracking-tight text-on-surface-variant/40 ml-1">ACS URL</Label>
                                        ...
                                        <div className="flex flex-wrap gap-8">
                                            <div className="flex items-center gap-5 p-5 bg-card rounded-2xl ring-1 ring-on-surface/5 shadow-sm">
                                                <Switch
                                                ...
                                                />
                                                <div className="flex flex-col">
                                                    <span className="text-[12px] font-bold tracking-tight text-on-surface">Sign Response</span>
                                            ...
                                            <div className="flex items-center gap-5 p-5 bg-card rounded-2xl ring-1 ring-on-surface/5 shadow-sm">
                                                ...
                                                />
                                                <div className="flex flex-col">
                                                    <span className="text-[12px] font-bold tracking-tight text-on-surface">Encrypt Response</span>
                                    ...
                                    {samlProviders.map(sp => (
                                        <div key={sp.entity_id} className="flex flex-col md:flex-row items-center justify-between p-10 hover:bg-surface-container/20 transition-all group">
                                            <div className="flex-1 min-w-0 pr-10 space-y-4">
                                                <div className="flex items-center gap-4">
                                                    <Badge className="bg-on-surface/5 text-on-surface-variant/60 rounded-xl font-bold text-[10px] tracking-tight px-3 border-none">Provider</Badge>
                                                ...
                                                <div className="flex gap-3 pt-2">
                                                    <Badge className={`rounded-lg font-bold text-[10px] tracking-tight px-2.5 py-1 border-none ${sp.sign_assertions ? 'bg-success-subtle text-success' : 'bg-surface-container text-on-surface-variant/20'}`}>Signed</Badge>
                                                    <Badge className={`rounded-lg font-bold text-[10px] tracking-tight px-2.5 py-1 border-none ${sp.encrypt_assertions ? 'bg-success-subtle text-success' : 'bg-surface-container text-on-surface-variant/20'}`}>Encrypted</Badge>
                                                </div>
                                            </div>
                                            <Button variant="ghost" size="icon" className="h-14 w-14 rounded-2xl hover:bg-destructive/10 hover:text-destructive transition-all" onClick={() => handleDeleteSAMLProvider(sp.entity_id)}>
                ...
                <TabsContent value="scim" className="space-y-10 animate-in fade-in duration-500">
                    <GlassCard className="border-none shadow-xl shadow-on-surface/5 bg-card rounded-[40px] overflow-hidden ring-1 ring-on-surface/5">
                        <GlassCardHeader className="bg-surface-container p-12 relative overflow-hidden">
                            ...
                            <div className="relative z-10 space-y-6">
                                <div className="flex items-center gap-4">
                                    <Badge className="bg-primary/10 text-primary rounded-xl h-7 font-bold text-[10px] tracking-tight px-4">Provisioning</Badge>
                                    <span className="text-[11px] font-bold tracking-tight text-on-surface-variant/40">Enabled</span>
                                </div>
                                <GlassCardTitle className="text-5xl font-bold tracking-tight text-on-surface leading-tight">SCIM Directory Sync</GlassCardTitle>
                        ...
                        <GlassCardContent className="p-12 space-y-16">
                            ...
                            <div className="space-y-10">
                                <h3 className="text-[12px] font-bold tracking-tight text-on-surface-variant/40 border-b border-on-surface/5 pb-6">SCIM Settings</h3>
                                <div className="grid gap-10 md:grid-cols-2">
                                    <div className="p-10 bg-card ring-1 ring-on-surface/5 rounded-[32px] space-y-4 shadow-sm">
                                        <Label className="text-[12px] font-bold tracking-tight text-on-surface-variant/40 ml-1">SCIM URL</Label>
                                        <div className="flex gap-3">
                                            ...
                                            <Button variant="ghost" className="h-12 w-12 rounded-xl bg-surface-container/30 ring-1 ring-on-surface/5 p-0 hover:bg-primary hover:text-primary-foreground transition-all shadow-sm" onClick={() => handleCopyValue('SCIM URL', `${window.location.origin}/scim/v2`)}>
                                                <Copy className="h-5 w-5" />
                                            </Button>
                                        </div>
                                    </div>
                                ...
                                <div className="p-10 bg-surface-container/30 rounded-[40px] flex flex-col md:flex-row items-center justify-between gap-10 ring-1 ring-on-surface/5 border-2 border-dashed border-on-surface/5">
                                    <div className="flex items-center gap-8">
                                        <div className="p-4 bg-card rounded-2xl shadow-sm cursor-pointer hover:bg-primary/5 transition-all ring-1 ring-on-surface/5" onClick={() => setActiveTab('keys')}>
                                            <Key className="w-8 h-8 text-primary" />
                                        </div>
                                        <div className="space-y-2">
                                            <h4 className="text-2xl font-bold tracking-tight text-on-surface">API Key</h4>
                                            <p className="text-sm font-medium text-on-surface-variant/40 max-w-lg">Generate an API key from the API Keys tab and use it in your identity provider.</p>
                                        </div>
                                    </div>
                                    <Button onClick={() => setActiveTab('keys')} className="h-14 bg-primary text-primary-foreground rounded-2xl font-bold text-sm px-10 transition-all shadow-lg shadow-primary/20">
                                        Go to API Keys
                                    </Button>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 pt-10">
                                <div className="space-y-10">
                                    <div className="flex items-center gap-6 border-b border-emerald-500/20 pb-6">
                                        <div className="h-10 w-10 bg-success-subtle rounded-xl flex items-center justify-center text-success font-bold text-xs ring-1 ring-emerald-500/20 shadow-sm">AZ</div>
                                        <h4 className="text-2xl font-bold tracking-tight text-on-surface">Azure AD Setup</h4>
                                    </div>
                                    <ul className="space-y-6">
                                        {[
                                            ...
                                            <li key={i} className="flex gap-5 group">
                                                <span className="font-mono text-success/40 font-bold text-xs group-hover:text-success transition-colors">0{i + 1}</span>
                                ...
                                <div className="space-y-10">
                                    <div className="flex items-center gap-6 border-b border-primary/20 pb-6">
                                        ...
                                        <h4 className="text-2xl font-bold tracking-tight text-on-surface">Okta Setup</h4>
                                    </div>
                                    <ul className="space-y-6">
                                        {[
                ...
                <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 bg-on-surface/20 backdrop-blur-md animate-in fade-in duration-300">
                    <GlassCard className="w-full max-w-3xl border-none shadow-2xl overflow-hidden rounded-[40px] scale-in-center bg-card">
                                ...
                                <div className="space-y-3">
                                    {(quickstartApp.redirect_uris || []).map((uri, index) => (
                                        <div key={index} className="flex gap-3">
                                            ...
                                            <Button variant="ghost" className="h-12 w-12 rounded-xl bg-surface-container/50 p-0 group flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-all shadow-sm" onClick={() => handleCopyValue(`URI ${index + 1}`, uri)}>
                        ...
                        <div className="bg-surface-container p-10 flex justify-end">
                            <Button className="bg-primary text-primary-foreground rounded-xl font-bold text-sm px-12 h-12 shadow-lg shadow-primary/20 transition-all" onClick={() => setQuickstartApp(null)}>Done</Button>
                        </div>
                    </GlassCard>
                </div>
            )}
            ...
            {editAppOpen && editingApp && (
                <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 bg-on-surface/20 backdrop-blur-md animate-in fade-in duration-300">
                    <GlassCard className="w-full max-w-2xl border-none shadow-2xl overflow-hidden rounded-[40px] scale-in-center bg-card">
                        <GlassCardHeader className="bg-surface-container p-12">
                            <GlassCardTitle className="text-4xl font-bold tracking-tight text-on-surface">Edit Application</GlassCardTitle>
                            <p className="text-on-surface-variant/60 font-medium text-sm mt-3">Update your application settings.</p>
                        </GlassCardHeader>
                        <GlassCardContent className="p-12 space-y-12 overflow-y-auto max-h-[60vh] custom-scrollbar bg-card">
                            <form id="edit-app-form" onSubmit={handleUpdateApp} className="space-y-10">
                                ...
                                <div className="grid grid-cols-2 gap-10">
                                    ...
                                    <div className="space-y-2.5">
                                        <Label className="text-[12px] font-bold tracking-tight text-on-surface-variant/40 ml-1">App ID</Label>
                        ...
                        <div className="bg-surface-container p-10 flex justify-between items-center">
                            <Button variant="ghost" className="text-on-surface-variant/40 hover:text-on-surface rounded-xl font-bold text-[11px] uppercase tracking-wider px-8" onClick={() => { setEditAppOpen(false); setEditingApp(null); }}>Cancel</Button>
                            <Button type="submit" form="edit-app-form" className="bg-primary text-primary-foreground rounded-xl font-bold text-sm px-12 h-12 shadow-lg shadow-primary/20 transition-all">Save Changes</Button>
                        </div>
                    </GlassCard>
                </div>
            )}
                ...
                <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 bg-on-surface/20 backdrop-blur-md animate-in fade-in duration-300">
                    <GlassCard className="w-full max-w-2xl border-none shadow-2xl overflow-hidden rounded-[40px] scale-in-center bg-card">
                        <GlassCardHeader className="bg-surface-container p-12 relative overflow-hidden">
                            ...
                            <div className="relative z-10 space-y-4">
                                <div className="flex items-center gap-4">
                                    <Badge className="bg-primary/10 text-primary rounded-xl h-7 font-bold text-[9px] tracking-tight px-4 border-none">Access Control</Badge>
                                </div>
                                <GlassCardTitle className="text-4xl font-bold tracking-tight text-on-surface leading-tight">User Permissions</GlassCardTitle>
                                <p className="text-on-surface-variant/60 font-medium text-sm mt-3">App: {selectedAppAssignments.name}</p>
                            </div>
                        </GlassCardHeader>
                        <GlassCardContent className="p-12 space-y-12 bg-card">
                            <form onSubmit={handleAssignUser} className="flex gap-4">
                                ...
                                <Button type="submit" className="h-14 bg-primary text-primary-foreground rounded-xl font-bold text-sm px-10 shadow-lg shadow-primary/20 transition-all">
                                    Add User
                                </Button>
                            </form>
                                ...
                                <div className="max-h-[40vh] overflow-y-auto space-y-3 custom-scrollbar pr-2">
                                    {assignmentsLoading ? (
                                        ...
                                        assignedUsers.map(user => (
                                            <div key={user} className="flex justify-between items-center p-5 bg-card ring-1 ring-on-surface/5 rounded-2xl hover:ring-primary/20 hover:bg-primary/5 transition-all shadow-sm group">
                                                <div className="flex items-center gap-5">
                                                ...
                                                <Button variant="ghost" size="sm" className="h-10 rounded-xl hover:bg-destructive/10 hover:text-destructive text-destructive font-bold uppercase text-[10px] tracking-widest transition-all" onClick={() => handleUnassignUser(user)}>
                                                    Revoke
                                                </Button>
                                            </div>
                                        ))
                        ...
                        <div className="bg-surface-container p-10 flex justify-end">
                            <Button className="bg-card text-on-surface rounded-xl font-bold text-sm px-12 h-12 shadow-sm ring-1 ring-on-surface/5 hover:ring-on-surface/10 transition-all" onClick={() => setAssignmentsOpen(false)}>Done</Button>
                        </div>
                    </GlassCard>
                </div>
            )}
            ...
            {logsOpen && selectedLogApp && (
                <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 bg-on-surface/20 backdrop-blur-md animate-in fade-in duration-300">
                    <GlassCard className="w-full max-w-5xl border-none shadow-2xl overflow-hidden rounded-[40px] scale-in-center bg-card h-[90vh] flex flex-col">
                        <GlassCardHeader className="bg-surface-container p-12 relative overflow-hidden shrink-0">
                            ...
                            <div className="relative z-10 flex items-center justify-between">
                                <div className="space-y-4">
                                    <div className="flex items-center gap-4">
                                        <Badge className="bg-primary/10 text-primary rounded-xl h-7 font-bold text-[11px] tracking-tight px-4 border-none">App Activity</Badge>
                                    </div>
                                    <GlassCardTitle className="text-5xl font-bold tracking-tight text-on-surface leading-tight">Audit Logs</GlassCardTitle>
                                    <p className="text-on-surface-variant/40 font-bold tracking-tight text-[11px] mt-2">App: {selectedLogApp.name} // Type: {selectedLogApp.type}</p>
                                </div>
                                <Button
                                    variant="ghost"
                                    className="h-14 w-14 rounded-2xl bg-card shadow-sm ring-1 ring-on-surface/5 hover:bg-destructive/10 hover:text-destructive transition-all"
                                            ...
                                            <div key={log.id} className="group">
                                                ...
                                                >
                                                    <div className="flex items-center gap-10">
                                                        <div className={`w-16 h-10 flex items-center justify-center font-bold text-xs rounded-xl shadow-sm ring-1 ring-on-surface/5 ${log.status_code >= 400 ? 'bg-destructive/10 text-destructive' : 'bg-success-subtle text-success'}`}>
                                                            {log.status_code}
                                                        </div>
                                                    ...
                                                    <div className="p-10 bg-surface-container/10 border-t border-on-surface/5 grid grid-cols-1 lg:grid-cols-2 gap-10 animate-in slide-in-from-top-2 duration-300">
                                                        <div className="space-y-4 flex flex-col h-[500px]">
                                                            <div className="flex items-center justify-between border-b border-on-surface/5 pb-4 ml-1">
                                                                <h4 className="text-[12px] font-bold tracking-tight text-on-surface-variant/40">Request Data</h4>
                                                            ...
                                                            <div className="bg-on-surface text-primary p-8 rounded-[32px] font-mono text-[11px] whitespace-pre-wrap overflow-auto flex-1 shadow-2xl ring-1 ring-on-inverse/10 custom-scrollbar leading-relaxed">
                                                                {log.request_payload ? JSON.stringify(JSON.parse(log.request_payload), null, 4) : '{}'}
                                                            </div>
                                                        </div>
                                                        <div className="space-y-4 flex flex-col h-[500px]">
                                                            <div className="flex items-center justify-between border-b border-on-surface/5 pb-4 ml-1">
                                                                <h4 className="text-[12px] font-bold tracking-tight text-on-surface-variant/40">Response Data</h4>
                                                                <Badge className="bg-success/10 text-success rounded-lg text-[10px] font-bold px-2 h-6 border-none">JSON v1</Badge>
                                                            </div>
                                                            <div className="bg-on-surface text-emerald-400 p-8 rounded-[32px] font-mono text-[11px] whitespace-pre-wrap overflow-auto flex-1 shadow-2xl ring-1 ring-on-inverse/10 custom-scrollbar leading-relaxed">
                        ...
                        <div className="bg-surface-container p-10 flex justify-between items-center shrink-0 border-t border-on-surface/5">
                            <div className="flex items-center gap-4 text-on-surface-variant/40">
                                ...
                                <span className="text-[10px] font-bold tracking-tight text-on-surface-variant/40">Logs are stored for 72 hours.</span>
                            </div>
                            <Button className="bg-primary text-primary-foreground rounded-xl font-bold text-sm px-12 h-12 shadow-lg shadow-primary/20 transition-all" onClick={() => setLogsOpen(false)}>Done</Button>
                        </div>
                    </GlassCard>
                </div>
            )}
