...
export const GlassCardHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
    ({ className, ...props }, ref) => (
        <CardHeader
            ref={ref}
            className={cn("bg-transparent border-b border-on-surface/5 p-4 px-5", className)}
            {...props}
        />
    )
);
...
export const GlassCardTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLHeadingElement>>(
    ({ className, ...props }, ref) => (
        <CardTitle
            ref={ref}
            className={cn(
                "text-sm font-bold tracking-tight text-on-surface flex items-center gap-2 uppercase",
                className
            )}
            {...props}
        />
...
export const GlassCardContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
    ({ className, ...props }, ref) => (
        <CardContent ref={ref} className={cn("p-5", className)} {...props} />
    )
);
...
export const GlassCardFooter = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
    ({ className, ...props }, ref) => (
        <CardFooter
            ref={ref}
            className={cn("px-5 py-3 bg-surface-container/10 border-t border-on-surface/5", className)}
            {...props}
        />
    )
);
...
export const GlassTableHead = React.forwardRef<HTMLTableCellElement, React.ThHTMLAttributes<HTMLTableCellElement>>(
    ({ className, ...props }, ref) => (
        <TableHead
            ref={ref}
            className={cn(
                "font-bold text-[10px] py-2 px-4 text-on-surface-variant/40 tracking-tight uppercase",
                className
            )}
            {...props}
        />
